...
--
-- Dumping data for table `game_account_data`
--

LOCK TABLES `game_account_data` WRITE;
/*!40000 ALTER TABLE `game_account_data` DISABLE KEYS */;
INSERT INTO `game_account_data` VALUES (1,'test@test.com','e10adc3949ba59abbe56e057f20f883e','测试账号','','','','','',2,1790063656,1790063656,0);
/*!40000 ALTER TABLE `game_account_data` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `game_code_data`
--

LOCK TABLES `game_code_data` WRITE;
/*!40000 ALTER TABLE `game_code_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `game_code_data` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `game_level_data`
--

LOCK TABLES `game_level_data` WRITE;
/*!40000 ALTER TABLE `game_level_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `game_level_data` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `game_map_data`
--

LOCK TABLES `game_map_data` WRITE;
/*!40000 ALTER TABLE `game_map_data` DISABLE KEYS */;
INSERT INTO `game_map_data` VALUES (1,1,'001','新手村',100,100,2,1789958635,1789958635,0);
/*!40000 ALTER TABLE `game_map_data` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `game_player_data` WRITE;
/*!40000 ALTER TABLE `game_player_data` DISABLE KEYS */;
INSERT INTO `game_player_data` VALUES (2,1,1,'战神','warrior','men',2,'001',0,0,1,1,1,'009','034','010',1,2,0,100,10,1790068630,1790068747,0);
/*!40000 ALTER TABLE `game_player_data` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `game_server_data`
--

LOCK TABLES `game_server_data` WRITE;
/*!40000 ALTER TABLE `game_server_data` DISABLE KEYS */;
INSERT INTO `game_server_data` VALUES (1,'一区',2,1789958852,1789958852,0);
/*!40000 ALTER TABLE `game_server_data` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-09-22 17:37:35
